 ...
 *
 * **ولماذا واتساب لا البطاقة المطبوعة؟** لأنّ الدخول إلى البوّابة **رقمُ الملف
 * والجوال**، وبطاقةُ المريض تحمل الاثنين معًا. فطبعُ العنوان عليها يجعل بطاقةً
 * تُنسى على طاولةٍ مفتاحًا كاملًا لحساب صاحبها. أمّا الإرسال إلى جواله فيثبت
 * ملكيّته للجوال الذي هو نصفُ المفتاح.
 *
...
export function PortalInviteRow(
  ...
  return (
    <div className="mt-2 rounded-2xl border border-sky-200 bg-sky-50 px-3 py-2">
      <p className="text-[11px] font-extrabold text-navy-900">
      ...
      <div className="mt-1.5 flex flex-wrap gap-1.5">
        ...
        {whatsApp ? (
          <a href={`https://wa.me/${whatsApp}?text=${encodeURIComponent(invite.text)}`}
            ...
            className="rounded-xl bg-emerald-600 px-3 py-1 text-[11px] font-bold text-white">
        ...
        <button type="button"
          ...
          className="rounded-xl border border-slate-300 bg-white px-3 py-1 text-[11px] font-bold text-navy-800">
