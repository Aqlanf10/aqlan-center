...
/**
 * نافذةُ المتابعة — **واحدةٌ للمعلّقات وللمتغيّبين معًا**.
 *
 * ومن مضى على موعده أكثرُ منها لم يعد استدعاؤه متابعةً بل مبيعات، وقرارُه
 * للمالك في تقريرٍ لا في طابور عمل اليوم. والحدُّ يمنع أيضًا مسحًا لا نهاية له
 * على قاعدةٍ تكبر كل يوم.
 *
 * **وأن تكون واحدةً شرطٌ لا تفصيل.** فقد كانت المعلّقات تُقرأ إلى ستّين يومًا
 * والمتغيّبون إلى ثلاثين: فمن قرّرت الاستقبال أنّه «لم يحضر» وموعده قبل خمسة
 * وثلاثين يومًا كان **يخرج من المعلّقات ولا يدخل قائمة الاتصال** — يختفي
 * تمامًا، وهو نقيضُ ما بُني هذا القسم له. ونافذتان مختلفتان تُنتجان هذه الفجوة
 * حتمًا، مهما كان رقماهما.
 */
